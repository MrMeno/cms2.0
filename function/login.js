...
router.post('/login', function (req, res, next) {
    ...
    var token = req.cookies.access_token;
       var data = {
            jobId: req.query.job,//职位
            name: req.query.name,//姓名
            telHome: req.query.phone//电话
        };
    ...
    reqPost.end();
    reqPost.on('error', function (e) { });
}).post('/submitCert', function (req, res, next) {
    var token = req.cookies.access_token;
    ...
    var optionspost = {
        host: global.hostAddress,
        port: global.portNum,
        path: global.ctx + '/submitCert?access_token=' + token,
        method: 'POST',
        headers:postheaders
